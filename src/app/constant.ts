...
export const CHART_DATA = {
  ...
  xAxisData: [
    '07-29', '07-30', '07-31', '08-01', '08-02', '08-03', '08-04', '08-05', // 8个
    '08-06',
  ],
  yAxisName: '注册数量',
  series: [
    ...
    },
    {
      name: 'Prod DB',
      data: [
        155, 494, 26, 120, 77, 126 ,107, 120, // 8个
        112,
      ]
    },
    // self platform
