...
export const CHART_DATA = {
  ...
  legend: ['GA-Google Ads', 'GA-Meta', 'GA-X', 'GA-LinkedIn', 'GA-NoAds', 'GA-Sum', 'Prod DB'],
  xAxisData: ['07-29', '07-30', '07-31', '08-01', '08-02', '08-03', '08-04', '08-05'],
  yAxisName: '注册数量',
  series: [
    {
      name: 'GA-Google Ads',
      data: [82, 333, 8, 54, 52, 77, 56, 73]
    },
    {
      name: 'GA-Meta',
      data: [0, 3, 11, 0, 0, 0, 0, 0]
    },
    {
      name: 'GA-X',
    ...
    {
      name: 'GA-LinkedIn',
      data: [0, 0, 3, 2, 1, 0, 1, 1]
    },
    {
      name: 'GA-Sum',
      data: [82, 336, 22, 56, 53, 77, 57, 91]
    },
    {
      name: 'Prod DB',
      data: [155, 494, 26, 120, 77, 126 ,107, 120]
    },
    // self platform
    {
      name: 'Self-Platform-Google-Ads',
      data: [7, 299, 6, 54.5, 52, 83.5 ,59, 74]
    },
    {
